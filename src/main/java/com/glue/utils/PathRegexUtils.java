...
public class PathRegexUtils {
    ...
    public PathRegexUtils(StringBuilder pathBuilder, String separator) {
        this.pathBuilder = pathBuilder;
        this.separator = separator;
    }

    public PathRegexUtils(StringBuilder pathBuilder) {
        this.pathBuilder = pathBuilder;
        this.separator = DEFAULT_SEPARATOR;
    }

    public PathRegexUtils() {
        this.pathBuilder = new StringBuilder(DEFAULT_START);
        this.separator = DEFAULT_SEPARATOR;
    }

    public PathRegexUtils join(String content) {
    ...
    public String parsePath(String path) {
        ...
        Arrays.stream(pathModule)
                ...
                .map(row -> {
                    ...
                    if (StringUtils.isBlank(itemPath[0])) {
                        return new PathBuilderMeta.PathBuilder()
                                .withName(itemPath[1])
